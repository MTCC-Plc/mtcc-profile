...
export function CompanyAbout({ section }: { section: Content }) {
  return <section id={section.id} className={styles.about} aria-labelledby="about-title"><div className="shell">
    <div className={styles.aboutGrid}>
      ...
      <div className={styles.aboutImage}><Image src="/assets/section-photo.webp" alt="A traditional Maldivian ceremonial pavilion on the waterfront" fill sizes="(max-width: 800px) 100vw, 520px" /><div><span>Across 20 atolls</span><strong>Alongside the nation.</strong></div></div>
    </div>
